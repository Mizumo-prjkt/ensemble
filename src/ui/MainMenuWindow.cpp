    ...
    : QWidget(parent)
{
    ...
    setStyleSheet(QStringLiteral(
        ...
        "  color: #50fa7b;"
        "}"
        "QPushButton[class=\"actionBtn\"]:pressed {"
        "  background-color: #44475a;"
        "}"
        "QPushButton#startWritingBtn {"
        ...
        "  font-weight: bold;"
        "}"
        "QPushButton#startWritingBtn:hover {"
...
void MainMenuWidget::setupUi()
{
    ...
    scrollArea->setObjectName(QStringLiteral("menuScrollArea"));
    scrollArea->setWidgetResizable(true);
    scrollArea->setFrameShape(QFrame::NoFrame);
    scrollArea->setAlignment(Qt::AlignCenter);

    auto *containerWidget = new QWidget(scrollArea);
    containerWidget->setStyleSheet(QStringLiteral("background: transparent;"));

    auto *outerLayout = new QVBoxLayout(containerWidget);
    ...
    auto *centerCard = new QFrame(containerWidget);
    centerCard->setObjectName(QStringLiteral("centerCard"));
    centerCard->setFixedWidth(540);
    centerCard->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Minimum);

    m_layout = new QVBoxLayout(centerCard);
    m_layout->setContentsMargins(24, 24, 24, 20);
    ...
    subtitleLabel->setStyleSheet(QStringLiteral("font-size: 12px; color: #6272a4; background: transparent; margin-bottom: 2px;"));
    ...
    infoLayout->setContentsMargins(16, 12, 16, 14);
    ...
    motdText->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    actionsLabel->setStyleSheet(QStringLiteral("font-size: 11px; font-weight: 700; color: #6272a4; background: transparent; margin-top: 2px;"));
    ...
    m_startWritingBtn->setStyleSheet(QStringLiteral(
        "QPushButton {"
        "  background-color: #bd93f9;"
        "  color: #14151a;"
        "  border: none;"
